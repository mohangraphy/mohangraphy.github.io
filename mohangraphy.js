...
document.addEventListener('DOMContentLoaded', function(){/* ── Deep linking — read URL hash and navigate directly ── */
  var hash = window.location.hash;
  if(hash){
    var val = hash.replace('#','');

    if(val === 'travel-stories'){
      showStoriesIndex(); return;
    }
  ...
  /* ── Auto-update URL bar as user navigates ── */
