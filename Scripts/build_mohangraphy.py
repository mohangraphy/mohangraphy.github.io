...
def generate_html():
    ...
    <head>
        ...
        <style>
            ...
            .submenu a, .nested-header {{ color: #666; padding: 12px 20px; text-decoration: none; font-size: 11px; letter-spacing: 2px; text-transform: uppercase; text-align: center; display: block; transition: 0.2s; }}
            ...
            footer {{ 
                ...
                z-index: 5000; display: flex; align-items: center; justify-content: center; gap: 60px; 
            }}
        </style>
    </head>
    <body>
    ...
    for m_cat in main_cats:
        ...
        # Check if photos exist to decide nav action
        ...
        nav_html += f'<div class="nav-item" id="nav-{m_cat}"><a href="#" class="nav-link" onclick="{nav_action}">{m_cat}</a>'
    ...
    <footer>
        <a href="#" class="footer-link" onclick="goHome()">Home</a>
        <a href="#main-nav" class="footer-link">Back to Top</a>
    </footer>
    <script>
    ...
    print("✅ Build Complete: Uniform font sizes. Hybrid menu logic (Places deep / Nature flat).")
